...
"
      ...
      <Block
        ...
        text="(also referred as Terms) mean these Terms and Conditions that form the entire agreement
        between You and CryptOnlyFanz regarding the use of the Service.
        "
      />
      <Block
        title="Third-party Social Media Service"
        text="means any services or content (including data, information, products or services) provided by a
        third-party that may be displayed, included or made available by the Service.
        "
      />
      <Block
        title="Website"
        text="refers to CryptOnlyFanz, accessible from Http://www.cryptonlyfanz.com
        "
      />
      <Block
        title="You"
        text="means the individual accessing or using the Service, or the company, or other legal entity on
        behalf of which such individual is accessing or using the Service, as applicable
        "
      />
      <Block
        title="Acknowledgment"
        text="These are the Terms and Conditions governing the use of this Service and the agreement that
        operates between You and the Company. These Terms and Conditions set out the rights and
        obligations of all users regarding the use of the Service."
      />
      <Block
        text="Your access to and use of the Service is conditioned on Your acceptance of and compliance with
        these Terms and Conditions. These Terms and Conditions apply to all visitors, users and others
        who access or use the Service."
      />
      <Block
        text="By accessing or using the Service You agree to be bound by these
      Terms and Conditions. If You disagree with any part of these Terms and
      Conditions then You may not access the Service."
      />
      <Block
        text="You represent that
      you are over the age of 18. The Company does not permit those under 18 to
      use the Service."
      />
      <Block
      ...
      />
      <Block
        text="The Company has no control over, and assumes no responsibility for, the content, privacy
      ...
      />
      <Block
        text="We strongly advise You to read the terms and conditions and privacy policies of any third-party
        web sites or services that You visit.
        "
      />
      <Block
        title="Termination"
        text="We may terminate or suspend Your access immediately, without prior notice or liability, for any
      ...
      <Block
        ...
        text="Not withstanding any damages that You might incur, the entire liability of the Company and any
      ...
      />
      <Block
        text="To the maximum extent permitted by applicable law, in no event shall the Company or its
      ...
      />
      <Block
        text="Some states do not allow the exclusion of implied warranties or limitation of liability for
        incidental or consequential damages, which means that some of the above limitations may not
        apply. In these states, each party's liability will be limited to the greatest extent permitted by law.
        
        "
      />
      <Block
        title="'AS IS' and 'AS AVAILABLE' Disclaimer "
        text="The Service is provided to You 'AS IS' and 'AS AVAILABLE' and with all faults and defects
      ...
      />
      <Block
        text="Without limiting the foregoing, neither the Company nor any of the company's provider makes
        ...
        or currency of any information or content provided through the Service; or (iv) that the Service,its servers, the content, or e-mails sent from or on behalf of the Company are free of viruses,
        scripts, trojan horses, worms, malware, or other harmful components.
      ...
      <Block
        title="Governing Law "
        text="The laws of the Country, excluding its conflicts of law rules, shall govern this Terms and Your
        use of the Service. Your use of the Application may also be subject to other local, state, national,
      ...
      <Block
        ...
        text="If You are a European Union consumer, you will benefit from any mandatory provisions of the
      ...
      <Block
        title="Severability "
        text="If any provision of these Terms is held to be unenforceable or invalid, such provision will be
      ...
      <Block
        title="Waiver "
        text="Except as provided herein, the failure to exercise a right or to require performance of an
      ...
      <Block
        ...
        text="These Terms and Conditions may have been translated if We have made them available to You
      ...
      />
      <Block
        text="By continuing to access or use Our Service after those revisions become effective, You agree to
